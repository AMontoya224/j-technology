...
function Footer( props ) {
    ...
    return (
        <footer>
            ...
            <p>© Copyright 2021 - 2022   |   J-Technology. All rights reserved.   |   <b onClick={() => onPage('/privacy-policy')}>Privacy Policy</b>   |   <b onClick={() => onPage('/terms-conditions')}>Terms and Conditions</b></p>
        </footer>
    );
}
